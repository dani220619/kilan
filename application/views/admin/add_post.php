<div class="main-panel">
    <div class="content">
        <div class="page-inner">
            <form class="admin" method="post" action="<?= base_url('post/insert_post'); ?>" enctype="multipart/form-data">
                <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="post_format" name="post_format" placeholder="Enter Format">
                                        </div>
                                    </div>
                                    <div class="col-md-12 col-lg-12">
                                        <div class="form-group">
                                            <label for="topic">Topic</label>
                                            <input type="text" class="form-control" id="post_topic" name="post_topic" placeholder="Enter Title">
                                        </div>
                                    </div>
                                    <div class="col-md-12 col-lg-12">
                                        <div class="form-group">
                                            <label for="title">Link</label>
                                            <input type="text" class="form-control" id="post_link" name="post_link" placeholder="Enter Link">
                                        </div>
                                    </div>
                                    <div class="col-md-12 col-lg-12">
                                        <div class="form-group">
                                            <label for="comment">Body</label>
                                            <textarea class="ckeditor" id="ckedtor" name="post_body" rows="5"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
