                     ...
                     <li class="nav-item">
                         ...
                         <div class="collapse" id="master">
                             <ul class="nav nav-collapse">
                                 ...
                                 <li>
                                     <a href="<?= base_url('post/index') ?>">
                                         <span class="sub-item">Post</span>
                                     </a>
                                 </li>
                                 <li>
                                     <a href="<?= base_url('gallery/post_gallery') ?>">
                                         <span class="sub-item">Post Gallery</span>
                                     </a>
                                 </li>
                                 <li>
                                     <a href="<?= base_url('network/index') ?>">
                                         <span class="sub-item">Network</span>
                                     </a>
                                 </li>
